static char normfgcolor[]        = "#3c3836";  // Foreground color (texto)
static char normbgcolor[]        = "#fbf1c7";  // Background color (fundo)
static char normbordercolor[]    = "#d5c4a1";  // Border color (bordas)
static char normfloatcolor[]     = "#d3869b";  // Float color (janelas flutuantes)
...
static char selbordercolor[]     = "#fabd2f";  // Border color (bordas)
...
static char titlenormbgcolor[]   = "#fbf1c7";  // Background color (fundo)
static char titlenormbordercolor[] = "#d5c4a1";  // Border color (bordas)
static char titlenormfloatcolor[] = "#d3869b";  // Float color (janelas flutuantes)
...
static char hidselfgcolor[]      = "#a89984";  // Foreground color (texto selecionado)
static char hidnormbgcolor[]     = "#fbf1c7";  // Background color (fundo)
static char hidselbgcolor[]      = "#fbf1c7";  // Background color (fundo selecionado)

// Cores de urgência
static char urgfgcolor[]         = "#fbf1c7";  // Foreground color (texto)
