...
static const struct arg args[] = {
	...
	{ wifi_essid,		"^b#282828^^c#fabd2f^ ^b#282828^^c#ebdbb2^%s",		"wlp5s0" },
	{ wifi_perc,		"^b#282828^^c#ebdbb2^%s󰏰 ",				"wlp5s0" },
	//{ netspeed_rx,	"^b#282828^^c#fabd2f^  ^b#282828^^c#ebdbb2^%s",	"wlp5s0" },
	//{ netspeed_tx,	"^b#282828^^c#fabd2f^  ^b#282828^^c#ebdbb2^%s",	"wlp5s0" },
