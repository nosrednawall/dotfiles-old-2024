...
static const Block blocks[] = {
    ...
    //    {"^d^ ^b#458588^^c#1d2021^  ^b#83a598^ ", "sensors | grep 'edge' | cut -b 16,17,18,19",	                5,	 0},
    {"^d^ ^b#689d6a^^c#1d2021^  ^b#8ec07c^ ", "block-ram used",    						10,	 0},
    {"^d^ ^b#d79921^^c#1d2021^  ^b#fabd2f^ ", "block-battery perc BAT1",  					60,	 0},
    {"^d^ ^b#cc241d^^c#1d2021^  ^b#fb4934^ ", "/bin/sh -c date +%c",						1,	 0},
    {"^d^ ","",0,0}
};
...
/*
    ...
    //{"^d^ ^b#cc241d^^c#1d2021^ ^b#fb4934^ ", "block-datetime \"%a. %d %b. %Y\" ",				60,	 0},
*/
/*
